...
urlpatterns = [
    ...
    path(r'equipe/', EquipeList.as_view(), name='Lista de Integrantes da Equipe'),
    path(r'equipe/<int:pk>', EquipeDetails.as_view(), name='Seleção do Integrante da Equipe por id'),
